...
function ploterps_bss_oldsystem(ERP, binArray, chArray, pstyle, chMGFP,  blcorr, xaxlim, yaxlim, linew, isinvertedY, fschan, fslege, fsaxtick, errorstd,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if pstyle==4 || pstyle == 5 % topo or Gina
        if isinvertedY
                tydir = -1;
        else
                tydir = 1;
        ...
        elseif pstyle==5
            plottopo_II_bss_oldsystem( dataaux(:, tp1:tp2, binArray), options{:})
        end
else
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
