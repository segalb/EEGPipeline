...
if nargin==1
        ...
        defx = {[EEG(1).xmin*1000 EEG(1).xmax*1000] 100 200 100  1:EEG(1).nbchan 0};
...
global outmwppth;  % EW added 3/23/2015 to get values
