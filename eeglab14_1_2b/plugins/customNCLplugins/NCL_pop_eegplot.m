...
function com = NCL_pop_eegplot( EEG, icacomp, superpose, reject, topcommand, varargin)
...
if icacomp == 1
	NCL_eegplot( EEG.data, 'srate', EEG.srate, 'title', 'Scroll channel activities -- NCL_eegplot()', ...
