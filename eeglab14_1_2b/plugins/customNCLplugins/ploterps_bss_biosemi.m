...
function ploterps_bss_biosemi(ERP, binArray, chArray, pstyle, chMGFP,  blcorr, xaxlim, yaxlim, linew, isinvertedY, fschan, fslege, fsaxtick, errorstd,...
...
if pstyle==4 || pstyle == 5 % topo or Gina
        ...
        elseif pstyle==5
            plottopo_II_bss_biosemi( dataaux(:, tp1:tp2, binArray), options{:})
        end
else
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
