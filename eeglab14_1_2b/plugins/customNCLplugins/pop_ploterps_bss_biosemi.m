...
function [ERP, erpcom] = pop_ploterps_bss_biosemi(ERP, binArray, chanArray, varargin)
erpcom = '';
if nargin < 1
        help pop_ploterps
        return
...
if nargin==1  %with GUI
        ...
        % Somersault
        %
        [ERP, erpcom] = pop_ploterps_bss_biosemi(ERP, binArray, chanArray, 'AutoYlim', rAutoYlim, 'BinNum', rBinNum, 'Blc', blcorr,...
...
ploterps_bss_biosemi(ERP, binArray, chanArray,  qpstyle, qMgfp, qBlc, qxscale, qyscale, qLineWidth, qisiy, qFontSizeChan, qFontSizeLeg, qFontSizeTicks, qerrorstd,...
