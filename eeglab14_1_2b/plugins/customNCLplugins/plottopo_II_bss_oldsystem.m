...
function plottopo_II_bss_oldsystem(data, varargin)
...
%
  ...
  if ~isempty(g.geom)
    ...
    if plotgrid
        ...
        %BEN'S OLDSYSTEM LOCATIONS
        xvals=[-1 1 1 0 0 0 -.5 -.5 -1 -1 -1 -.5 -.5 -.75 -.75 -.5 -.25 -.25 0 .25 .25 0 .5 .75 .75 .5 .5 0.5 1 1 1 0.5];
        yvals=[.6 .6 -.45 .4 .1 -.25 .1 .6  .4 .1 -.25 -.45 .4 .25 -.05 -.25 .25 -.05 .6 .25 -.05 -.45 .4 .25 -.05 -.25 .1 .6 .4 .1 -.25 -.45];
